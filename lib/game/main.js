...
(function() {
  ...
  ig.module('game.main').requires('game.entities.player', 'impact.entity', 'impact.game', 'impact.font', 'game.levels.plains', 'game.levels.villiage').defines(function() {
    window.sounds = {};
    window.LD25Game = ig.Game.extend({
      ...
      startGame: function() {
        ...
        this.currentLevel = this.loadLevel(LevelVilliage);
